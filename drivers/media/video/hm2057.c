...
/* init 680*480 VGA --> change 800 x 600(SVGA) */
...
{0x0020,0x48}, //0x48,0x08

{0x0023,0xfB}, // 2012.11.21 , 0xfb->ok,0xcb,0xeb
...
static int sensor_init(struct v4l2_subdev *sd, u32 val)
{
    ...
    mdelay(20);  //delay 5 microseconds
#endif
			       ...
			       struct i2c_client *client)
{
    ...
    /* soft reset */
#if 0
    ret = sensor_write(client, 0x0022/*0xff*/, 0x00 /*0x1*/);
    if (ret != 0) {
        SENSOR_TR("soft reset %s failed\n",SENSOR_NAME_STRING());
        ret = -ENODEV;
		goto sensor_video_probe_err;
    }
    mdelay(10);          //delay 10 microseconds
#endif
    //sensor->model = SENSOR_V4L2_IDENT;
    //return 0;

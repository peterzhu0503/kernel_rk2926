...
#define SENSOR_NAME RK29_CAM_SENSOR_GC0308I
#define SENSOR_V4L2_IDENT V4L2_IDENT_GC0308I
...
static int sensor_s_fmt(struct v4l2_subdev *sd, struct v4l2_mbus_framefmt *mf)
{
    ...
    defined(CONFIG_SOC_CAMERA_GC0308_INTERPOLATION_3M) || \
    defined(CONFIG_SOC_CAMERA_GC0308_INTERPOLATION_5M)
...
static int sensor_try_fmt(struct v4l2_subdev *sd, struct v4l2_mbus_framefmt *mf)
{
    ...
    {
        set_w = SENSOR_MAX_WIDTH;
        set_h = SENSOR_MAX_HEIGHT;
    }
#endif
    else
    {

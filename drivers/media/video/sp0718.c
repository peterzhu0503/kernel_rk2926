...
//AE target
#define  SP0718_P1_0xeb  0x78	//0x70////0x78
#define  SP0718_P1_0xec  0x72//0x6a	//0x78
...
//saturday param test
	...
	///	{0x16 , 0xa0///r<th
	///gc镜头照人脸偏黄
	{0xa0 , 0x59},///59 ///80///a6///a6///a6///8c///80///59///59///
	{0xa1 , 0x00},///0c ///00///da///da///da///fa///00///0c///00///
	{0xa2 , 0x2a},///19 ///00///00///00///00///fa///00///19///26///	0x26	20121217
	{0xa3 , 0xed},///00 ///da///da///e7///da///da///e7///00///ed///
	{0xa4 , 0x93},///80 ///e6///c0///c0///c0///c0///a6///80///93///
	{0xa5 , 0x00},///00 ///c0///e7///da///e7///e7///f4///00///00///
	{0xa6 , 0x00},///00 ///f4///f4///00///00///00///00///00///00///
	{0xa7 , 0x00},///00 ///c0///c0///b4///a7///cd///da///c0///e7///
	{0xa8 , 0x80},///80 ///cc///cc///cc///d9///b3///a6///c0///99///
	{0xa9 , 0x00},///00 ///00///0c///0c///0c///3c///00///00///00///
	{0xaa , 0x03},///00 ///33///33///33///33///33///33///00///03///
	{0xab , 0x00},///00 ///0f///0f///0c///0c///0c///0c///0c///0c///
/*
	{0xac , 0x00},///a6///a2///b3///8c///
	{0xad , 0x0a},///04///0c///0c///
	{0xae , 0x00},///da///c0///e7///
	{0xaf , 0xda},///cd///cd///b4///
	{0xb0 , 0xcc},///d9///e6///e6///
...
static int sensor_s_fmt(struct v4l2_subdev *sd, struct v4l2_mbus_framefmt *mf)
{
	...
	else if (((set_w <= 320) && (set_h <= 240)) && sensor_qvga[0].reg)
    {
        ...
        set_w = SENSOR_INIT_WIDTH;//320; 20130508 kavie
        set_h = SENSOR_INIT_HEIGHT;//240;20130508 kavie
    }

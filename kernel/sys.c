 ...
 */
extern void codec_set_spk(bool on);   //lizhengwei add关机静音
extern int   hardware_mute_pin_can_action;   //lizhengwei add
...
void kernel_power_off(void)
{
	...
	if(hardware_mute_pin_can_action){
	    codec_set_spk(0) ;   //lizhengwei add 关机静音
	    printk(KERN_EMERG "Mute pin work after Power down. add by lzw \n");
	 }

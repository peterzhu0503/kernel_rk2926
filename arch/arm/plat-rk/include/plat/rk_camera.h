...
#define RK29_CAM_SENSOR_GC0308I gc0308i
#define RK29_CAM_SENSOR_GC0309  gc0309
#define RK29_CAM_SENSOR_GC2015  gc2015
#define RK29_CAM_SENSOR_GC2035  gc2035   //lizhengwei add
...
#define RK29_CAM_SENSOR_HM2057  hm2057   //liufeng@20130418 add 
#define RK29_CAM_SENSOR_SP0718  sp0718   //chinsea20130506 add
#define RK29_CAM_SENSOR_SP0A19  sp0a19   //chinsea20130520 add
#define RK29_CAM_SENSOR_GC0311  gc0311   //chinsea20130520 add
...
#define RK29_CAM_SENSOR_NAME_GC0308I "gc0308i"
#define RK29_CAM_SENSOR_NAME_GC0309  "gc0309"
#define RK29_CAM_SENSOR_NAME_GC2015  "gc2015"
#define RK29_CAM_SENSOR_NAME_GC2035  "gc2035"   //lizhengwei add
...
#define RK29_CAM_SENSOR_NAME_HM2057  "hm2057"   //liufeng@20130418 add 
#define RK29_CAM_SENSOR_NAME_SP0718  "sp0718"   //chinsea20130506 add
#define RK29_CAM_SENSOR_NAME_SP0A19  "sp0a19"   //chinsea20130506 add
#define RK29_CAM_SENSOR_NAME_GC0311  "gc0311"   //chinsea20130617 add
...
#if defined(CONFIG_SOC_CAMERA_GC0308_INTERPOLATION_2M)
#define gc0308i_FULL_RESOLUTION    0x200000 // 2 megapixel
#elif defined(CONFIG_SOC_CAMERA_GC0308_INTERPOLATION_3M)
#define gc0308i_FULL_RESOLUTION    0x300000 // 3 megapixel
#elif defined(CONFIG_SOC_CAMERA_GC0308_INTERPOLATION_5M)
#define gc0308i_FULL_RESOLUTION    0x500000 // 5 megapixel
#else
#define gc0308i_FULL_RESOLUTION    0x30000            // 0.3 megapixel
#endif
#define gc0309_FULL_RESOLUTION     0x30000            // 0.3 megapixel
#define gc2015_FULL_RESOLUTION     0x200000           // 2 megapixel
#define gc2035_FULL_RESOLUTION     0x200000           // 2 megapixel   lizhengwei add
...
#define hm2057_FULL_RESOLUTION      0x200000           // 2 megapixel   liufeng@20130418 add 
#define sp0718_FULL_RESOLUTION      0x30000            // 2 megapixel   //chinsea20130506 add
#define sp0a19_FULL_RESOLUTION      0x30000            // 2 megapixel   //chinsea20130506 add
#define gc0311_FULL_RESOLUTION      0x30000            // 2 megapixel   //chinsea20130617 add

...
#ifdef	CONFIG_INCAR_PNLVCOM_ADJUST    //stephenchan for TP reset pin as P2B2
#define	GPIO2B_LCDC0_HSYNC              0
#define	GPIO2B_LCDC1_HSYNC              0

#define	GPIO2B_LCDC0_VSYNC              0
#define	GPIO2B_LCDC1_VSYNC              0
#else

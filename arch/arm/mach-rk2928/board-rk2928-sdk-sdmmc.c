...
//define reset-pin
	    ...
	    #if defined(CONFIG_SDMMC0_RK29_SDMMC_DET_TSD)
	    #define RK29SDK_SD_CARD_DETECT_N                RK2928_PIN2_PA3  //According to your own project to set the value of card-detect-pin.
	    #define RK29SDK_SD_CARD_INSERT_LEVEL            GPIO_LOW         // set the voltage of insert-card. Please pay attention to the default setting.
	    #define RK29SDK_SD_CARD_DETECT_PIN_NAME         GPIO2A3_NAND_RDN_NAME
	    #define RK29SDK_SD_CARD_DETECT_IOMUX_FGPIO      GPIO2A_GPIO2A3
	    #define RK29SDK_SD_CARD_DETECT_IOMUX_FMUX       GPIO2A_NAND_RDN
	    #else
...
//
    ...
    #define WIFI_HOST_WAKE RK2928_PIN3_PC0 
        ...
        //#define CONFIG_USB_WIFI_POWER_CONTROLED_BY_GPIO	/* PJF@201226: disable wifi gpio power */
